...
namespace PixelCrushers.DialogueSystem.SequencerCommands {
	...
	/// </summary>
	public class SequencerCommandDeshabilitarFinalEscena2 : SequencerCommand {
		
		
		public void Start() {
			ControlEscena2 control;
			control = GameObject.Find ("ControladorEscena").GetComponent<ControlEscena2> ();
			control.desHabilitaEscenaSiguiente();
		}
	}
}
//DeshabilitarFinalEscena2()