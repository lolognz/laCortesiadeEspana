...
namespace PixelCrushers.DialogueSystem.SequencerCommands {
	...
	/// </summary>
	public class SequencerCommandDeshabilitarFinalEscena3 : SequencerCommand {
		
		
		public void Start() {
			ControlEscena3_3 control;
			control = GameObject.Find ("ControladorEscena").GetComponent<ControlEscena3_3> ();
			control.desHabilitaEscenaSiguiente();
		}
	}
}
//DeshabilitarFinalEscena3()