...
namespace PixelCrushers.DialogueSystem.SequencerCommands {
	...
	/// </summary>
	public class SequencerCommandDeshabilitarLabelScene1 : SequencerCommand {
		
		
		public void Start() {
			GestorMensajesDialogue control;
			control = GameObject.Find ("ControladorEscena").GetComponent<GestorMensajesDialogue> ();
			control.deshabilitaUsableEscena1();
		}
	}
}
//DeshabilitarLabelScene1();