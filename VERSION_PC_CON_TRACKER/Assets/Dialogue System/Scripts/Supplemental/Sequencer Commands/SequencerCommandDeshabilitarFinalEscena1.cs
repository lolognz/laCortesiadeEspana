...
namespace PixelCrushers.DialogueSystem.SequencerCommands {
	...
	/// </summary>
	public class SequencerCommandDeshabilitarFinalEscena1 : SequencerCommand {
		
		
		public void Start() {
			ControlEscena1_2 control;
			control = GameObject.Find ("ControladorEscena").GetComponent<ControlEscena1_2> ();
			control.desHabilitaEscenaSiguiente();
		}
	}
}
//DeshabilitarFinalEscena1()