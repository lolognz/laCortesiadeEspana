			...
			try{
				if (nombreAnimacion == "hablando" && estadoAnimacion){
					if (nombrePersonaje == "Zorrilla" || nombrePersonaje == "Zorrilla.")
						...
						GameObject.Find("Default Dialogue UI").GetComponent<PixelCrushers.DialogueSystem.UnityGUI.UnityDialogueUI> ().guiRoot.guiSkin.label.normal.textColor = new Color32 (251, 0, 0, 255);
						...
						GameObject.Find("Default Dialogue UI").GetComponent<PixelCrushers.DialogueSystem.UnityGUI.UnityDialogueUI> ().guiRoot.guiSkin.label.normal.textColor = new Color32 (255, 0, 255, 255);
