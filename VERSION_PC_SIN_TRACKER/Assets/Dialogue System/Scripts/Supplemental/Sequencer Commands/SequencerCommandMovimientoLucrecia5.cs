...
namespace PixelCrushers.DialogueSystem.SequencerCommands {
	...
	/// </summary>
	public class SequencerCommandMovimientoLucrecia5 : SequencerCommand {
		private Animator anim;
		public void Start() {
			GameObject.Find ("ControladorEscena").GetComponent<ControlEscena3_2_2> ().caminarLucreciaSalir ();
			Stop();
		}
	}
}
