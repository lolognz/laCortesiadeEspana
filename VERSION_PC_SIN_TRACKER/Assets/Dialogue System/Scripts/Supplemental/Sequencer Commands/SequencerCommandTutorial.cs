...
namespace PixelCrushers.DialogueSystem.SequencerCommands {
	...
	/// </summary>
	public class SequencerCommandTutorial : SequencerCommand {
		
		public void Start() {
			GameObject controlEscena;
			controlEscena = GameObject.Find ("ControladorEscena");
			controlEscena.GetComponent<controlEscena1> ().activarTutorialLucrecia ();
			Stop();
		}
	}
}
